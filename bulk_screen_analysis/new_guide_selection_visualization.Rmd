...
VPR_window_results <- readr::read_delim('bin_analysis/num_VPR_pvalues.txt',delim='\t',col_names=c('bin','coeff','pval'))
...
VPR_window_results <- readr::read_delim('bin_analysis/num_VPR_pvalues.txt',delim='\t',col_names=c('bin','coeff','pval'))
VPR_window_speed <- readr::read_delim('bin_analysis/speed_VPR_pvalues.txt',delim='\t',col_names=T)
...
KRAB_window_speed <- readr::read_delim('bin_analysis/speed_KRAB_pvalues.txt',delim='\t',col_names=T)
